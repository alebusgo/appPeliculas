...
export default function ResultadosBusqueda(){
    ...
    /*
        ...
        2. POR CADA CAMBIO DE ESTADO DESPUES DE RENDERIZAR SE EJECUTA -> Actualización del ciclo.
            ...
            <div className="dv-busqueda">
                <form onSubmit={handleSubmit}>
                    <fieldset>
                        ...
                        <input type="text" id="busqueda" name="busqueda" onChange={handleChange} placeholder="Título de la pélícula..."></input>
                    </fieldset>
                </form>
            </div>
            <div>
